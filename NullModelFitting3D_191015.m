%%This is the curve fitting script I am writing to help Hannah Foster with
%%her project. I am going to set this up using the fitting toolbox that
%%MATLAB ships with.
...
%%Specified Variables:
bindingSite = 0; %This is the size of the binding Site you are going to be testing. Important to remember that the system can't use data with DNALength == bindingSite
...
inputPrompt = input('Which scheme do you want to test? 2 or 3 or 4 or 5:');
...
%%%Input check.
elseif (inputPrompt ~= (2 || 3 || 4 || 5))
    disp('You have to pick either 2 or 3 or 4 or 5!');
end
